...
public class OrderServiceImpl implements OrderService {
    ...
    public boolean deleteOrderById(int id) {
        if(orderinfoMapper.deleteOrderById(id)==1)
            return true;
        else return false;
    }
    ...
    public PageInfo<Order> findOrderByPage(Integer pageNum, Integer limitNum) {
        ...
        PageInfo<Order> info = new PageInfo<Order>(orderinfoMapper.findAllOrders());
        return info;
    }
    ...
    public PageInfo<Order> searchOrderByPage(Integer page, Integer limit, int jobId, String state) {
        ...
        PageInfo<Order> info = new PageInfo<Order>(orderinfoMapper.searchOrder(jobId,state));
        return info;
    }
