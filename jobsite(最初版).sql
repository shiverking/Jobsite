...
ALTER TABLE `category` ADD CONSTRAINT `job_id` FOREIGN KEY (`job_id`) REFERENCES `job` (`id`);
ALTER TABLE `comment` ADD CONSTRAINT `reviewer_id` FOREIGN KEY (`reviewer_id`) REFERENCES `user` (`id`);
ALTER TABLE `comment` ADD CONSTRAINT `commented_id` FOREIGN KEY (`commented_id`) REFERENCES `user` (`id`);
ALTER TABLE `hire` ADD CONSTRAINT `order_id` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`);
ALTER TABLE `hire` ADD CONSTRAINT `employer_id` FOREIGN KEY (`employer_id`) REFERENCES `user` (`id`);
ALTER TABLE `hire` ADD CONSTRAINT `employee_id` FOREIGN KEY (`employee_id`) REFERENCES `user` (`id`);
ALTER TABLE `job` ADD CONSTRAINT `employer_id` FOREIGN KEY (`employer_id`) REFERENCES `user` (`id`);
ALTER TABLE `message` ADD CONSTRAINT `sender_id` FOREIGN KEY (`sender_id`) REFERENCES `user` (`id`);
ALTER TABLE `message` ADD CONSTRAINT `receiver_id` FOREIGN KEY (`receiver_id`) REFERENCES `user` (`id`);
ALTER TABLE `order` ADD CONSTRAINT `job_id` FOREIGN KEY (`job_id`) REFERENCES `job` (`id`);
ALTER TABLE `orderlog` ADD CONSTRAINT `user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
ALTER TABLE `orderlog` ADD CONSTRAINT `order_id` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`);
ALTER TABLE `profile` ADD CONSTRAINT `user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION;
ALTER TABLE `sendresume` ADD CONSTRAINT `job_id` FOREIGN KEY (`job_id`) REFERENCES `job` (`id`);
ALTER TABLE `sendresume` ADD CONSTRAINT `profile_id` FOREIGN KEY (`profile_id`) REFERENCES `profile` (`id`);
ALTER TABLE `transactionrecords` ADD CONSTRAINT `account_id` FOREIGN KEY (`record`) REFERENCES `account` (`id`);
ALTER TABLE `workpublisher` ADD CONSTRAINT `fk_workpublisher_user_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
